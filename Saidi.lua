...
local N = (Redis:get(Saidi.."Name:Bot") or "سيلفا")
...
--download('https://raw.githubusercontent.com/EIGEBT/Saidi-SELVA/master/Saidi.lua','Saidi.lua')
...
NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "سيلفا")
...
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "سيلفا")
local BotName = {
...
if text == (Redis:get(Saidi.."Saidi:Name:Bot") or "سيلفا") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local UserInfo = LuaTele.getUser(Saidi)
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
